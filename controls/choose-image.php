...
/**
 * Elementor choose image
 *
 * A base control for creating choose image control. Displays radio buttons styled as
 * groups of images for each option.
 *
 * @since 1.0.0
 */
class Choose_Image extends Base_Data_Control {
    ...
    public function enqueue() {
        wp_enqueue_script(
            ...
            HAPPY_ASSETS . 'backend/controls.js'
        );

        wp_enqueue_style(
            'ha-elementor-controls',
            HAPPY_ASSETS . 'backend/controls.css'
        );
    }
