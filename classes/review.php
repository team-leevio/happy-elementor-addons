        ...
        if ( ! in_array( $pagenow, $exclude ) ) {
            ...
            printf( __( '<div class="notice ha-notice ha-notice--extended">
                ...
                <div class="ha-notice__content">
                    ...
                    <div class="ha-notice__actions">
                        <a href="%s" class="ha-button ha-button--cta"><span>Yes, You Deserve It!</span></a>
                        <a href="%s" class="ha-button ha-button--cta ha-button--outline"><span>Remind Me Later</span></a>
                        <a href="%s" class="ha-button ha-button--cta ha-button--error ha-button--outline"><span>No Thanks</span></a>
                    </div>
                </div>
