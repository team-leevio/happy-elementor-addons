	...
	protected function register_content_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'description'       => sprintf('Paste icon code from <a target="_blank" href="%1$s">lordicon.com</a> <br /> <a target="_blank" href="%2$s">Learn how to get Lordicon CDN</a><br><br>
                Example: https://cdn.lordicon.com/gmzxduhd.json', esc_url('https://lordicon.com/'), esc_url('https://happyaddons.com/')),
                'default'       => __('https://cdn.lordicon.com/gmzxduhd.json','happy-elementor-addons'),
                'condition' => [
                    'icon_method' => 'cdn'
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'media_types' => ['json'],
                'description'       => __('Download Json file from lordicon.com','happy-elementor-addons'),
                'condition' => [
                    'icon_method' => 'file'
                ]
            ]
	...
	protected function __icon_style_controls() {
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .ha-icon-box-icon' => 'background: {{VALUE}};'
                ]
			]
		);
