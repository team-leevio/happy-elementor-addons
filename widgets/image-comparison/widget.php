...
class Image_Comparison extends Base {
    ...
    protected static function get_data_settings( $settings ) {
        ...
        $data = [];
        foreach ( $map as $setting_key => $param_key ) {
	...
	protected function render() {
        ...
        $this->add_render_attribute( 'container', 'data-settings', wp_json_encode( self::get_data_settings( $settings ) ) );
        ?>
    ...
    public function _content_template() {
        ...
        view.addRenderAttribute( 'container', 'data-settings', JSON.stringify(dataSettings) ); #>
