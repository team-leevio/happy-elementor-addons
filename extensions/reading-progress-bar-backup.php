...
class Reading_Progress_Bar {
	...
	public function render_reading_progress_bar_html() {
		...
		//error_log(print_r($document_settings_data, true));

		$global_enable = isset($document_settings_data['ha_reading_progress_bar_enable_globaly']) && $document_settings_data['ha_reading_progress_bar_enable_globaly'] === 'yes';
    	$page_enable = isset($document_settings_data['ha_reading_progress_bar_enable']) && $document_settings_data['ha_reading_progress_bar_enable'] === 'yes';
        ...
        $settings_data = [
			'reading_progress_is_enable' => $document_settings_data['ha_reading_progress_bar_enable'],
			'progress_bar_type' => $progress_bar_type,
			'rpb_vertical_position' => !empty($document_settings_data['ha_rpb_vertical_position']) ? $document_settings_data['ha_rpb_vertical_position'] : ''
		];
