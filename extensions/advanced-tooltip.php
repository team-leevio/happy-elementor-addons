...
class Advanced_Tooltip {
    ...
    public static function init() {
        ...
        add_action( 'elementor/element/common/after_add_attributes', [__CLASS__, 'add_attributes'] );
    }

    // public function get_name() {
    //     return 'ha-advanced-section';
    // }
    ...
    public static function add_attributes( Element_Base $element ) {
		...
		if ( $settings['ha_advanced_tooltip_enable'] == 'yes' ) {
			$element->add_render_attribute( '_wrapper', 'class', 'ha-advanced-tooltip' );
		}
	}
    ...
    public static function dhseioghieghioerhgoierghioergignergneri($element) {
        $settings = $element->get_settings_for_display();
