...
class Heading_Text_Animation {
    ...
    public function register_scripts() {
        ...
        wp_register_script(
            ...
            HAPPY_ADDONS_PRO_ASSETS . 'js/heading-text-animation' . $suffix . 'js',
    ...
    public function register_styles() {
        ...
        wp_register_style(
            'happy-heading-text-animation',
            HAPPY_ADDONS_PRO_ASSETS . 'css/widgets/heading-text-animation.min.css',
            [],
            HAPPY_ADDONS_PRO_VERSION
        );
    }
    ...
    public function add_content_controls( $element ) {
        ...
        $element->add_control(
            ...
            [
                ...
                'default'            => 'reveal',
                'options'            => [
                    'chars'     => __( 'Character', 'happy-elementor-addons' ),
