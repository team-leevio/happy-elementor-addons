    ...
    <div class="ha-home-body">
        <div class="ha-row ha-py-5 ha-align-items-center">
            <div class="ha-col ha-col-6">
                ...
                <a class="ha-btn ha-btn-primary" target="_blank" rel="noopener" href="">Take Me to The Knowledge Page</a>
            </div>
            <div class="ha-col ha-col-6">
        ...
        <div class="ha-row ha-py-5 ha-pt-0">
            ...
            <div class="ha-col ha-col-12 ha-align-center ha-pt-2">
                <a class="ha-btn ha-btn-secondary" target="_blank" rel="noopener" href="">View more videos</a>
            </div>
        </div>
        <div class="ha-row ha-align-items-end ha-py-5 ha-pt-0">
            ...
            <div class="ha-col ha-col-3 ha-align-right">
                <a class="btn-more" href="">Get More FAQ ></a>
            </div>
        ...
        <div class="ha-row ha-py-5">
            ...
            <div class="ha-col ha-col-6">
                <div class="ha-border-box ha-min-height-455">
                    ...
                    <a class="ha-btn ha-btn-primary" target="_blank" rel="noopener" href="">Subscribe Now</a>
                </div>
            </div>
        </div>
        ...
        <div class="ha-row ha-py-5 ha-align-items-center">
            ...
            <div class="ha-col ha-col-6">
                ...
                <a class="ha-btn ha-btn-primary" target="_blank" rel="noopener" href="">Request Feature</a>
            </div>
        </div>
                ...
                <div class="ha-border-box">
                    <div class="ha-row ha-align-items-center">
                        ...
                        <div class="ha-col ha-col-8">
                            ...
                            <a class="ha-btn ha-btn-secondary" target="_blank" rel="noopener" href="">I’m Happy to Give You 5*</a>
                        </div>
                    </div>
                </div>
            </div>
