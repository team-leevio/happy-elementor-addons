...
$widgets = self::get_features();
$inactive_widgets = \Happy_Addons\Elementor\Extensions_Manager::get_inactive_features();
...
<div class="ha-dashboard-panel">
    <div class="ha-dashboard-panel__header">
        <div class="ha-dashboard-panel__header-content">
            ...
            <p class="f16"><?php printf( esc_html__( 'Here is the list of our all %s features. You can enable or disable features from here to optimize loading speed and Elementor editor experience. %sAfter enabling or disabling any feature make sure to click the Save Changes button.%s', 'happy-elementor-addons' ), $total_widgets_count, '<strong>', '</strong>' ); ?></p>
        ...
        foreach ( $widgets as $widget_key => $widget_data ) :
            ...
            <div class="<?php echo $class_attr; ?>">
                ...
                <div class="ha-dashboard-widgets__item-toggle ha-toggle">
                    <input id="ha-widget-<?php echo $widget_key; ?>" <?php echo $checked; ?> type="checkbox" class="ha-toggle__check ha-feature" name="features[]" value="<?php echo $widget_key; ?>">
